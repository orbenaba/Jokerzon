...
// Opposite means that the purchase was committed by the current account
export default function Purchase(props) {
    ...
    let leftDate = props.opposite?getEstimatedDateFormatted(props.purchase.purchase[DATE_OF_PURCHASE], props.purchase.purchase[ESTIMATED_DAYS]):getDateFormatted(Number(props.purchase.purchase[DATE_OF_PURCHASE])*1000);
    let rightDate = props.opposite?getDateFormatted(Number(props.purchase.purchase[DATE_OF_PURCHASE])*1000):getEstimatedDateFormatted(props.purchase.purchase[DATE_OF_PURCHASE], props.purchase.purchase[ESTIMATED_DAYS]);
    ...
    return (
        <div className="py-5">
            <div className="container" style={{fontFamily:'cursive'}}>
                <div className="row">
                    <h4 style={{color:'rgb(102,0,51)', marginRight:'1rem'}}>{leftDate}</h4>
                    ...
                    <h4 style={{color:'rgb(102,0,51)', marginRight:'1rem'}}>{rightDate}</h4>
                </div>
